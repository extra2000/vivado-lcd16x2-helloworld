...
set _xil_proj_name_ "lcd16x2-helloworld"
...
set orig_proj_dir "[file normalize "$origin_dir/../run/lcd16x2-helloworld"]"
...
set obj [get_filesets sim_1]
set_property -name "top" -value "helloworld_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
if { [get_files lcd16x2.v] == "" } {
  import_files -quiet -fileset sources_1 "${origin_dir}/../src/verilog/lcd16x2.v"
}
...
# helloworld
  ...
  set block_cell_name helloworld_0
  if { [catch {set helloworld_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $helloworld_0 eq "" } {
...
if { [get_property IS_LOCKED [ get_files -norecurse arty_z7_20.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../run/lcd16x2-helloworld/lcd16x2-helloworld.gen/sources_1/bd/arty_z7_20/hdl/arty_z7_20_wrapper.v" ]
} else {
